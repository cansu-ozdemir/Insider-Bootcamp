$(document).ready(function() {
    ...
    const $userContainer = $('.ins-api-users');
    ...
    const displayUsers = (users) => {
        ...
        $('<button>').addClass('delete-btn').attr('data-id', user.id).text('Sil').appendTo(userCard);
                
            $userContainer.append(userCard);
        });


        $userContainer.off('click', '.delete-btn').on('click', '.delete-btn', function() {
    ...
    const deleteUser = (userId) => {
        ...
        let storedData = JSON.parse(localStorage.getItem('userData')) || {users: []};
    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            $('#retry-fetch').on('click', async function() {
